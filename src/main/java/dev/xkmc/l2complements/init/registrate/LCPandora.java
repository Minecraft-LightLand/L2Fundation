...
public class LCPandora {
	...
	private static <T extends Item> ItemBuilder<T, L2Registrate> item(String id, NonNullFunction<Item.Properties, T> factory) {
		return L2Complements.REGISTRATE.item(id, factory)
				.model((ctx, pvd) -> pvd.generated(ctx, pvd.modLoc("item/pandora/" + id)));
	}

	private static ItemEntry<DescCurioItem> descItem(String id, String name, String desc) {
